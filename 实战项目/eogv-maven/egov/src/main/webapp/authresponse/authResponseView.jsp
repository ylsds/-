      ...
      <tr>
        ...
        <td bgcolor="#f3ffe3"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#0e6f68" >
          ...
          <tr>
            ...
            <td bgcolor="#FFFFFF" class="STYLE1"><div align="left" style="padding:2px" class="STYLE2"><%=StringUtil.getregcryByCode(((Auth)request.getAttribute("auth")).getRegcry())%></div></td>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="9" background="../images/tab_12.gif">&nbsp;</td>
        <td bgcolor="#f3ffe3"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#0e6f68">
          <tr height="26"><td bgcolor="#FFFFFF" height="26" class="STYLE1" colspan="2" align="center"><button id="addBtn" style="padding-left:0px;padding-top:0px;width:68px;height:27px" onclick="window.location='/egov/servlet/UpdateFeek?authno=${auth.authno}'" ><img id="addBtnImg" src="../images/response.jpg" /></button>&nbsp;&nbsp;<button type="button" style="padding-left:0px;padding-top:0px;width:68px;height:27px;cursor:hand" onclick="document.location='authResponseList.html'" ><img src="../images/back.jpg"/></button></td></tr>
        </table></td>
        <td width="9" background="../images/tab_16.gif">&nbsp;</td>
      </tr>
    </table></td>
